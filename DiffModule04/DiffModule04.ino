...
bool prtDiag = true;
// Objects
ScalePot potA = ScalePot(kMtrA_PotPin, 0.1, 0.5);	//Define function to read potentiometer and scale.
ScalePot potB = ScalePot(kMtrB_PotPin, 0.1, 0.5);	//Define function to read potentiometer and scale.
